#Customer Request Learning Team-Suite (Proof of concept, work in progress version)
import os
import pandas as pd
import numpy as np
...
def newSRClusterer(newSRText):  
    ...
    f_6_1 =  'old_service_request_x.xlsx'
    data_6_1 = pd.read_excel (f_6_1, sheet_name='SRN')
    data_6_1.to_csv (r'old_service_request_x.csv', index = None, header=True)

    f_6_1 =  'old_service_request_x.csv'
    ...
    if similarityScoreMean >= 0.7:
        ...
        print ('The Service Request is assigned to the cluster', newSRCluster)
        print ('The Service Request similarity to the assigned cluster:', round(similarityScoreMean,2))
    else:
        print ('This Service Request is unlike any detail in the training repository and is not assigned to any cluster')
...
'Transaction Hub',
'PartFocus 1.1 Support',
'PartFocus 1.2 Support',
'PartFocus 1.3 Support',
'PartFocus 2.1 Support',
'PartFocus 2.2 Support',
'PartFocus 2.3 Support',
'PartFocus 3.1 Support',
'PartFocus 3.2 Support',
'PartFocus 3.3 Support',
'PartFocus 4.1 Support',
'PartFocus 4.2 Support',
'PartFocus 4.3 Support',
'PartFocus 5.1 Support',
'PartFocus 5.2 Support',
'PartFocus 5.3 Support',
'PartFocus 6.1 Support',
'PartFocus 6.2 Support',
'PartFocus 6.3 Support',
'PartFocus 7.1 Support',
'PartFocus 7.2 Support',
'PartFocus 7.3 Support',
'PartFocus 8.1 Support',
'PartFocus 8.2 Support',
'PartFocus 8.3 Support'
}

#data file that contains old service requests
f_1 =  'old_service_request_x.xlsx'
#data_1 = pd.read_excel (f_1, sheet_name='SRN', converters={'short_description':str})

data_1 = pd.read_excel (f_1, sheet_name='SRN')
data_1.to_csv (r'old_service_request_x.csv', index = None, header=True)

f_1 =  'old_service_request_x.csv'
...
plt.title('CLRT-S Estimated number of clusters')
plt.show()

newSRClusterer('Transaction')
